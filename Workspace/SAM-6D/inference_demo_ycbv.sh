...
# set the paths
export CAD_PATH=$PWD/Data/Example_ycbv/obj_000015.ply    # path to a given cad model(mm)
export RGB_PATH=$PWD/Data/Example_ycbv/rgb.png           # path to a given RGB image
export DEPTH_PATH=$PWD/Data/Example_ycbv/depth.png       # path to a given depth map(mm)
export CAMERA_PATH=$PWD/Data/Example_ycbv/camera.json    # path to given camera intrinsics
export OUTPUT_DIR=$PWD/Data/Example_ycbv/outputs         # path to a pre-defined file for saving results
